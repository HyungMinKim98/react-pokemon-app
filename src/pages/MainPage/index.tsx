...
interface Props {
  ...
  setDisplayedPokemons: (pokemons: PokemonNameAndUrl[]) => void;
}

function SearchBox({ allPokemons, setDisplayedPokemons }: Props) {
...
function MainPage() {
  ...
  const fetchPokeData = async () => {
    try{
      ...
      setDisplayedPokemons(filterDisplayedPokemonData(pokemons));
    } catch(error) {
      console.error(error)
    }
  }
